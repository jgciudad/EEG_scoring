...
tf.app.flags.DEFINE_string("eeg_train_data", "../../file_list/75_subjects/scratch_training/eeg/train_list.txt", "Point to directory of input data")
tf.app.flags.DEFINE_string("eeg_eval_data", "../../file_list/75_subjects/scratch_training/eeg/eval_list.txt", "Point to directory of input data")
tf.app.flags.DEFINE_string("eeg_test_data", "../../file_list/75_subjects/scratch_training/eeg/test_list.txt", "Point to directory of input data")
