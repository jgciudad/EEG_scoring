...
tf.app.flags.DEFINE_string("eeg_test_data", "../../data_preprocessing/spindle_data/file_list/scratch_training/scorer_1/eeg1/test_list.txt", "Point to directory of input data")
...
tf.app.flags.DEFINE_string("eog_test_data", "../../data_preprocessing/spindle_data/file_list/scratch_training/scorer_1/eeg2/test_list.txt", "Point to directory of input data")
...
tf.app.flags.DEFINE_string("emg_test_data", "../../data_preprocessing/spindle_data/file_list/scratch_training/scorer_1/emg/test_list.txt", "Point to directory of input data")
tf.app.flags.DEFINE_string("out_dir", r'C:\Users\javig\Documents\Drive\DTU\MASTER THESIS\Code\EEG_scoring\SleepTransformer_mice\scratch_training\sleeptransformer\scratch_training_3chan_CPU_test2\n1\SPINDLE_evaluation/', "Point to output directory")
...
tf.app.flags.DEFINE_string("checkpoint_dir", r"C:\Users\javig\Documents\Drive\DTU\MASTER THESIS\Code\EEG_scoring\SleepTransformer_mice\scratch_training\sleeptransformer\scratch_training_3chan_CPU_test2\n1\checkpoint/", "Point to checkpoint directory")
...
test_gen_wrapper.compute_eeg_normalization_params()
test_gen_wrapper.compute_eog_normalization_params()
test_gen_wrapper.compute_emg_normalization_params()
nchannel = 3
